...
QEMU_VIRTFS_ENABLE = y  #jia
QEMU_VIRTFS_HOST_DIR = $(ROOT)/host
...
filelist-tee-common: optee-client xtest optee-examples
	...
	@find $(OPTEE_TEST_OUT_PATH) -type f -name "secStorTest" | \
		sed 's/\(.*\)/file \/bin\/secStorTest \1 755 0 0/g' 		>> $(fl)
